...
export const Chat = () => {
	...
	return (
		<div className='dark:bg-slate-800 dark:text-white flex flex-col flex-1 h-screen'>
			...
			<div className='flex items-center gap-2 px-2 pb-2 border-0 border-top border-solid border-gray-300'>
				...
				<div className='bg-white dark:border-purple-400 dark:bg-slate-700 w-full flex items-center border rounded-lg border-solid border-purple-700 pl-2 pr-1'>
					<textarea
