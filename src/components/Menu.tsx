export const Menu = () => {
	return (
		<div className='dark:bg-slate-800 dark:border-gray-700 w-[70px] h-screen border-0 border-r border-solid border-gray-200 flex items-center flex-col'>
			<div className='w-[45px] h-[45px] rounded-xl bg-purple-600 flex items-center justify-center my-2'>
