...
export const ListUser = () => {
	return (
		<div className='dark:border-gray-700 dark:bg-slate-800 dark:text-white h-screen overflow-auto flex flex-col w-[250px] border-0 border-r border-solid border-gray-300'>
					...
					{users.map(e => (
						...
						>
							<div className='relative'>
								...
								<div
									className={cn(
										'rounded-full h-2 w-2 absolute bottom-0 right-0 dark:shadow-slate-700 shadow-[0_0_0_4px_white]',
										{
